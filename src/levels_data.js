export default [
    ...
    },
    {
      ...
      recipes: [
        ...
        {input: ['Papier Vert', 'Ciseaux'], output: ['Papiers verts qu\'on pourrait confondre avec des billets']},
        {input: ['Papier', 'Ciseaux'], output: ['Papiers qu\'on pourrait confondre avec des billets, mais ils sont blancs']},
        {input: ['Papiers qu\'on pourrait confondre avec des billets, mais ils sont blancs', 'Crayons de couleur'], output: ['Papiers verts qu\'on pourrait confondre avec des billets']},
        {input: ['Malette', 'Papiers verts qu\'on pourrait confondre avec des billets'], output: ['Malette de billets']},],
